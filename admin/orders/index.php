        ...
        <tbody>
            ...
            <tr class="text-center">
                ...
                <?php
                        ...
                        $rowCity = getRow('ciry_id',$row['order_city_id'],'city');
                        $rowService = getRow('service_id',$row['order_serv_id'],'services');
                    ?>
                ...
                <td class="text-center">
                    <a href="#" class="btn btn-danger delete" data-field="order_id"
                        data-id="<?php echo $row['order_id']; ?>" data-table="orders">Delete</a>
                </td>
            </tr>
            <?php $x++; } ?>
